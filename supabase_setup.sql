...
create index if not exists
  arcade_wallet_transactions_user_created_idx
...
drop trigger if exists on_arcade_user_created
on auth.users;
...
public.apply_arcade_wallet_transaction(
  p_user_id uuid,
  p_amount integer,
  p_type text,
  p_reference text,
